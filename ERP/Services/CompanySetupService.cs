...
namespace ERP.Services
{
    public class CompanySetupService : ICompanySetupService
    {
        ...
        public async Task<CompanyDetailsDto?> GetByIdAsync(string id)
        {
        ...
        public async Task<(string Id, byte[] RowVersion)> CreateDraftAsync(CreateCompanyDto dto)
        {
        ...
        private async Task<Tenant?> GetTenantForUpdateAsync(string id)
        {
        ...
        public async Task<byte[]?> UpdateGeneralInfoAsync(string id, UpdateCompanyGeneralDto dto)
        {
        ...
        public async Task<byte[]?> UpdateFinancialsAsync(string id, UpdateCompanyFinancialsDto dto)
        {
            var tenant = await GetTenantForUpdateAsync(id);
            if (tenant == null) return null;
        ...
        public async Task<byte[]?> UpdateLocalizationAsync(string id, UpdateCompanyLocalizationDto dto)
        {
            var tenant = await GetTenantForUpdateAsync(id);
            if (tenant == null) return null;
        ...
        public async Task<byte[]?> UpdateAddressesAsync(string id, UpdateCompanyAddressesDto dto)
        {
            var tenant = await GetTenantForUpdateAsync(id);
            if (tenant == null) return null;
        ...
        public async Task<byte[]?> UpdateTaxesAsync(string id, UpdateCompanyTaxesDto dto)
        {
            var tenant = await GetTenantForUpdateAsync(id);
            if (tenant == null) return null;
        ...
        public async Task<byte[]?> UpdateSystemControlsAsync(string id, UpdateCompanySystemControlsDto dto)
        {
        ...
        public async Task<byte[]?> UpdateBankAccountsAsync(string id, UpdateCompanyBankAccountsDto dto)
        {
        ...
        public async Task<byte[]?> UpdateUsersAsync(string id, UpdateCompanyUsersDto dto)
        {
            var tenantInfo = await _context.Tenants.AsNoTracking()
                .Where(t => t.Id == id && t.IsActive)
                .Select(t => new { t.RowVersion })
